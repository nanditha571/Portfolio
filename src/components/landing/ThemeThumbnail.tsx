...
// Always provide a complete, valid portfolio object so the thumbnail never
// receives undefined or {} as data. This is intentionally decoupled from the
// user's own portfolio — theme cards always show the same sample preview.
 ...
 */
export const ThemeThumbnail = ({ themeId, className }: ThemeThumbnailProps) => {
